...
class LoadFeedFromCacheUseCaseTests: XCTestCase {
    ...
    private func expect(_ sut: LocalFeedLoader, toCompletion expectedResult: Result<[FeedImage], Error>, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
        action()
